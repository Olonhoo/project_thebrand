Vue.component('HeaderComp', {
    ...
    template: `
    <div class="header">
    <div class="container panel_icons">
        <div class="first_menu">
            <a href="" class="menu_logo logo_hover">
        ...
        <div class="second_menu">
            <a href="" class="margin_second_menu logo_hover">
                <svg width="32" height="23" viewBox="0 0 32 23" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" />
                </svg>
            </a>
            <a href="" class="margin_second_menu logo_hover logo_hover_mobile">
            ...
            <button class="btn-cart logo_hover logo_hover_mobile" type="button" @click="showCart = !showCart">
...
Vue.component('SearchComp', {
    ...
    template: `
        <div class="header__links__left--search">
            <form action="#" method="post" class="form_search" @submit.prevent="$root.$refs.products.filter(userSearch)">
                <input type="text" class="header__links__left--search-field" placeholder="Search" v-model="userSearch">
                    <button type="submit" class="menu_search logo_hover">
...
Vue.component('NavComp', {
    template: `
    <nav class="main_nav main_nav--close">
    <!-- main-nav--close -->
    <div class="main_nav_box">
        <div class="main_nav_flex">
            <p class="main_nav_header">MENU</p>
            <button class="main_nav_close">X</button>
        </div>
        <ul class="main_nav_list">
            <li class="main_nav_sublist"><a href="" class="main_nav_man">MAN</a>
                <ul class="main_nav_category">
                    <li class="main_nav_subcategory"><a href="#"
                            class="main_nav_subcategory_a">Accesories</a></li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">Bags</a>
                    </li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">Denim</a>
                    </li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">T-Shirts</a>
                    </li>
                </ul>
            </li>
        </ul>
        <ul class="main_nav_list">
            <li class="main_nav_sublist"><a href="" class="main_nav_man">WOMAN</a>
                <ul class="main_nav_category">
                    <li class="main_nav_subcategory"><a href="#"
                            class="main_nav_subcategory_a">Accessories</a></li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">Jackets &
                            Coats</a></li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">Polos</a>
                    </li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">T-Shirts</a>
                    </li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">Shirts</a>
                    </li>
                </ul>
            </li>
        </ul>
        <ul class="main_nav_list">
            <li class="main_nav_sublist"><a href="" class="main_nav_man">KIDS</a>
                <ul class="main_nav_category">
                    <li class="main_nav_subcategory"><a href="#"
                            class="main_nav_subcategory_a">Accesories</a></li>
                    <li class="main_nav_subcategory"><a href="#" class="main_nav_subcategory_a">Jackets &
